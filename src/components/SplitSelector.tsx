...
export default function SplitSelector({
  ...
  return (
    <div className="overflow-x-auto">
      <div className="inline-grid min-w-full grid-flow-col auto-cols-fr rounded-md border border-white/10 bg-surface/60 p-1">
        {splits.map((split) => {
          ...
          return (
            <Link
              ...
              className={`whitespace-nowrap rounded px-4 py-2 text-center font-stat text-xs transition-colors ${
                isActive
